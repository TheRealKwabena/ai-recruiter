...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'glass-panel w-full rounded-3xl border border-white/60 bg-white/90 p-6 shadow-soft-card',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn('text-2xl font-semibold leading-tight text-charcoal', className)}
    {...props}
  />
));
